       ...
       <div id="left" >
            <div class="media user-media well-small">
                <a class="user-link" href="#">
                    <img class="media-object img-thumbnail user-img" alt="User Picture" src="" />
                     
                </a>
                <br />
                <div class="media-body">
                    <h5 class="media-heading"> RainForest School</h5>
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                        <i class="icon-tasks"> </i> Admin Profile 
                    ...
                    <ul class="collapse" id="component-nav">
                        ...
                        <button data-toggle="modal" data-target="#upload_image_modal" class="btn btn-success btn-lg">Update Profile Picture</button>
                         <li class=""><a href="{{route('sch.updateprofile')}}"><i class="icon-angle-right"></i> Update profile </a></li>
                ...
                <li class="panel ">
                    ...
                    <ul class="collapse" id="form-nav">
                        <li class=""><a href="{{route('sch.managecourse')}}"><i class="icon-angle-right"></i>Manage Course </a></li>
                        <li class=""><a href="{{route('sch.addsection')}}"><i class="icon-angle-right"></i>Manage section </a></li>
                    </ul>
                </li>
                ...
                <li class="panel">
                    ...
                    <ul class="collapse" id="pagesr-nav">
                        <li><a href="{{route('sch.addstudent')}}"><i class="icon-angle-right"></i>Create student</a></li>

                    </ul>
                </li>
                <li class="panel">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#chart-nav">
                        <i class="icon-bar-chart"></i> Fees
                    ...
                    <ul class="collapse" id="chart-nav">
                        <li><a href="{{route('Fees.Payment')}}"><i class="icon-angle-right"></i>Student Payment</a></li>
                ...
                <li class="panel">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#DDL-nav">
                        <i class=" icon-sitemap"></i> Subjects
                    ...
                    <ul class="collapse" id="DDL-nav">
                        <li>
                             <li><a href="#"><i class="icon-angle-right"></i> Add Subject </a></li>

                    </ul>
                </li>
                <li class="panel">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#DDL4-nav">
                        <i class=" icon-folder-open-alt"></i> Attendance
                ...
                <li><a href="gallery.html"><i class="icon-film"></i> Examz </a></li>
                ...
                <li><a href="grid.html"><i class="icon-columns"></i> Grid </a></li>
                 <li class="panel">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#blank-nav">
                        <i class="icon-check-empty"></i> Exams
