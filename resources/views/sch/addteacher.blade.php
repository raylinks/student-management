...
<div id="wrap" >
    ...
    <div id="content">
        ...
        <div class="inner" style="min-height: 700px;">
            ...
            <button class="btn btn-primary" type="submit" data-toggle="modal" data-target="#myModal2">
                <span class="glyphicon glyphicon-plus"></span> ADD
            </button>

            <!-- END COMMENT AND NOTIFICATION  SECTION -->

            <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#upload_image_modal">Upload profile pix </button>
            ...
            <div class="table-responsive text-center">
                @if($users->count() > 0)
                    <table class="table table-borderless" id="table">
                        ...
                        <tbody id="teachers-list" name="teachers-list">
                        @foreach($users as $userss)
                            <tr id="teacher{{$userss->id}}">
                                <td>{{$userss->id}}</td>
                                <td>{{$userss->name}}</td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-warning btn-xs btn-detail open-modal" data-toggle="modal" data-target="#myModal3" value="{{$userss->id}}"><i class="fa fa-pencil"></i> Edit</button>
                                    <button class="btn btn-danger btn-xs btn-delete delete-task" value="{{$userss->id}}"><i class="fa fa-times"></i> Delete</button>
                                </td>
                            </tr>
                        @endforeach
                    </table>
